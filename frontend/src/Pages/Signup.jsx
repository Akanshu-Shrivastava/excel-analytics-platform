    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-center text-gray-600 mb-8">Join Excel Analytics today</p>
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 outline-none"
            >
              <option value="user">User</option>
              <option value="admin">Admin</option>
              {/* Hide Super Admin unless intentional */}
